...
&nbsp; &nbsp; &nbsp; <span class="hljs-keyword">if</span> (process.env.NODE_ENV !== <span class="hljs-string">'production'</span> &amp;&amp; !config.async) { &nbsp; &nbsp; &nbsp; &nbsp; flushSchedulerQueue() &nbsp; &nbsp; &nbsp; &nbsp; <span class="hljs-keyword">return</span> &nbsp; &nbsp; &nbsp; } &nbsp; &nbsp; &nbsp; nextTick(flushSchedulerQueue) &nbsp; &nbsp; } &nbsp; } } </code></pre>
