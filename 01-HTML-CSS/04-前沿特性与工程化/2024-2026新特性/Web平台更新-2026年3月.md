...
> 来源：[web.dev](https://web.dev/blog/web-platform-03-2026) | 日期：2026-03-31 | 事实状态复核于 2026-08-12
...
- 无需 JavaScript 高频监听滚动；浏览器可按动画属性和实现条件进行合成优化，但不能笼统表述为“运行在 worker 线程”
...
## Chrome 147 后续落地（2026 年 4 月已稳定发布）

- `contrast-color()`：自动返回黑/白以保证最佳对比度
- `border-shape`：自定义边框形状
- Element-scoped view transitions（已落地）
...
- Web Platform 2026 年 2 月更新（待补专题）
