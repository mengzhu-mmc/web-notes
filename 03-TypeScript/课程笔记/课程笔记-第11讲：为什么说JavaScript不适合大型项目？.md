...
```typescript
function getValue(o: T, name: K): T[K] {
...
type simpleTask = Pick// {title: string;description: string}
```
...
```typescript
const debounce = (func: T, wait: number = 0) => {
  let timeout: number | null = null
  let args: V
function debounced(...arg: V): Promise {
    args = arg
    if(timeout) {
