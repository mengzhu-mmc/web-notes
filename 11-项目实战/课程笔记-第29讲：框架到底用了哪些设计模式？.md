...
<span class="hljs-keyword">class</span> Sparrow <span class="hljs-keyword">extends</span> Bird { &nbsp; getFood() { &nbsp; &nbsp; <span class="hljs-keyword">return</span> [<span class="hljs-string">'虫子'</span>, <span class="hljs-string">'稻谷'</span>] &nbsp; } } </code></pre>
...
<span class="hljs-keyword">class</span> Sparrow <span class="hljs-keyword">implements</span> IBird { &nbsp; getFood() { &nbsp; &nbsp; <span class="hljs-keyword">return</span> [<span class="hljs-string">'虫子'</span>, <span class="hljs-string">'稻谷'</span>] &nbsp; } } </code></pre>
