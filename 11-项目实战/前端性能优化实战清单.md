...
>
> 难度：⭐低 ⭐⭐中 ⭐⭐⭐高　收益：🔥低 🔥🔥中 🔥🔥🔥高　实现成本：💰低 💰💰中 💰💰💰高

**本篇定位**：带成本收益标注的**可勾选清单**，用于项目自查与优化排期。三篇性能优化文档的分工：

| 文档 | 用途 | 什么时候看 |
| --- | --- | --- |
| [前端性能优化全景](../08-网络与浏览器/性能优化/前端性能优化全景.md) | 分层总览与导航 | 想快速建立全局认知，或不知道该往哪查 |
| [前端性能优化完全指南](./前端性能优化完全指南.md) | 分层详解 + 决策树 + 面试 Q&A | 要理解某个手段的原理与取舍 |
| **本篇** | 成本收益清单 | 要评估「这个项目该先做哪几项」 |

本篇独有内容：WebAssembly 适用场景、骨架屏实现、Critical CSS 内联。
