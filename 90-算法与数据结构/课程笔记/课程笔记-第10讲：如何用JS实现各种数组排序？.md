...
<span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> j = len - <span class="hljs-number">1</span>; j &gt; k; j--) { swap(<span class="hljs-number">0</span>, j) max_heapify(<span class="hljs-number">0</span>, j) }

<span class="hljs-keyword">return</span> arr } heap_sort(a); <span class="hljs-comment">// [1, 1, 3, 3, 6, 6, 23, 34, 76, 221, 222, 456]</span> </code></pre>
