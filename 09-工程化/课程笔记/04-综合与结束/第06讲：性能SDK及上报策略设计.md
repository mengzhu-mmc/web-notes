...
![](https://s0.lgstatic.com/i/image6/M00/16/F6/CioPOWBHIo6AZCY4AADtOp7Xkb8129.png)
...
```java
https://s1.static.com/common/perf/static/js/1.0.0/perf.min.js
try {
  perfInit ();
} catch (err) {
  console.warn(err);
...
![](https://s0.lgstatic.com/i/image6/M00/16/FE/CioPOWBHKOiACeX2AAKqstIoawE934.png)
