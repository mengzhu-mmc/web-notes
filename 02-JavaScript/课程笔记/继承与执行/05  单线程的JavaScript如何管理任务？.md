...
![](https://s0.lgstatic.com/i/image6/M00/37/A1/Cgp9HWB4EDeACyjFAAAW-kfzUR0259.png)
...
![](https://s0.lgstatic.com/i/image6/M00/37/A1/Cgp9HWB4EESAQnXYAAClWLdHiXU406.png)
...
![](https://s0.lgstatic.com/i/image6/M01/38/42/CioPOWB5CK-Ae-ZRAAG6BriFZRI860.png)
...
async function errorFunc() {  try {    await Promise.reject("error!!!"); } catch (e) {    console.log("error caught"); // 微1-3 }  console.log("errorFunc");  return Promise.resolve("errorFunc success"); } errorFunc().then((res) => console.log("errorFunc then res"));
