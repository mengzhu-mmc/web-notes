...
![](https://s0.lgstatic.com/i/image2/M01/04/F0/CgpVE1_4DdGAJ_EXAAE38RQC0js096.png)
...
let b = change(a); // 注意这里没有new，后面new相关会有专门文章讲解 console.log(b.age); // 第一个console console.log(a.age); // 第二个console
```
